...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        Veiculo v6 = new Veiculo("Toyota", "Corolla", 130.0, ETipoMotorizacao.flex, 55, 10.0);
        Veiculo v7 = new Veiculo("Hyundai", "HB20", 125.0, ETipoMotorizacao.flex, 48, 10.0);
        Veiculo v8 = new Veiculo("Honda", "Civic", 80.0, ETipoMotorizacao.flex, 52, 10.0);
        Veiculo v9 = new Veiculo("Chevrolet", "Onix", 112.0, ETipoMotorizacao.flex, 48, 10.0);
        Veiculo v10 = new Veiculo("Ford", "Ka", 108.0, ETipoMotorizacao.flex, 45, 10.0);
        Veiculo v11 = new Veiculo("Volkswagen", "Fox", 117.0, ETipoMotorizacao.flex, 47, 10.0);
        Veiculo v12 = new Veiculo("Fiat", "Uno", 95.0, ETipoMotorizacao.flex, 42, 10.0);
        Veiculo v13 = new Veiculo("Renault", "Kwid", 100.0, ETipoMotorizacao.flex, 40, 10.0);
        Veiculo v14 = new Veiculo("Toyota", "Etios", 110.0, ETipoMotorizacao.flex, 45, 10.0);
        Veiculo v15 = new Veiculo("BYD", "Dolphin", 190.0, ETipoMotorizacao.eletrico, 50, 10.0);
        ...
        // listando os 10 veiculos com menor autonomia
        System.out.println("\n- Listando os 10 veiculos com menor autonomia:");
        for(var veiculo : repository.ListarVeiculosMenorAutonomia())
            System.out.println(veiculo.getMarca() + " - " + veiculo.getModelo());

        // Listando os veiculos por tipo de motorização
        ...
        System.out.println("\n- Abastecendo veiculos:");
        repository.Abastecer(ETipoMotorizacao.gasolina, 10);

        // Veiculos com autonomia inferior ao informado
        System.out.println("\n- Veiculos com autonomia inferior ao informado:");
        System.out.println("Marca - Modelo: Autonomia, Motorização, Capacidade, QtdDisponivelTanque");
        for(var veiculo : repository.ListarVeiculosPorAutonomiaInferior(100.0))
